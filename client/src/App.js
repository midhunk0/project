...
import VerifyCompany from "./components/admin/VerifyCompany.js";
                ...
                {isLoggedIn() ? (
                    <>
                        <Route path="/recruiter" element={<Recruiter />}>
                            ...
                            <Route
                                path="placement"
                                element={<RecruiterPlacement />}
                            />
                            <Route
                                path="chat"
                                element={<RecruiterMessenger />}
                            />
                        ...
                        <Route path="/admin" element={<Admin />}>
                            ...
                            <Route path="company" element={<VerifyCompany />} />
                            <Route
                                path="invitations"
                                element={<Invitations />}
                            />
