...
const EditRecruiter=()=>{
    ...
    return (
        <Box padding="20px 60px" display="flex" width="100%" flexDirection="column" gap="20px" margin="20px" border="1px solid gray" borderRadius="5px" sx={{boxShadow:"1px 2px 9px gray"}} >
