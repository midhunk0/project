...
const VerifyCompany = () => {
  ...
  const fetchRecruiters = async () => {
    try {
      const response = await axios.get(
        "https://project-api-iwiy.onrender.com/api/recruiters/unverified"
      );
  ...
  const handleVerify = async (recruiterId) => {
    try {
      await axios.put(
        `https://project-api-iwiy.onrender.com/api/recruiters/${recruiterId}/verify`
      );
      fetchRecruiters();
      window.location.reload();
      const conversationResponse = await axios.post(
        "https://project-api-iwiy.onrender.com/api/students/conversations",
        {
  ...
  const handleReject = async (recruiterId) => {
    try {
      await axios.delete(
        `https://project-api-iwiy.onrender.com/api/recruiters/${recruiterId}`
      );
      fetchRecruiters();
      window.location.reload();
    } catch (error) {
